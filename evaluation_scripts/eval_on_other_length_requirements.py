...
save_base_path = base_dir+"/evaluation_scripts/results/qaw_words_requirement"
...
#model_evaluator = ModelEvaluator(pipeline=model, eval_modes=eval_modes, language=language, batch_size=batch_size,
