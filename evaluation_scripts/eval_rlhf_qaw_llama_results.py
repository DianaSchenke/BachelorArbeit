...
save_base_path = base_dir+"/evaluation_scripts/results/qaw_llama_rlhf"
...
model_path =  base_dir+"/output/orpo/qaw_llama_3_epochs_sft2024-11-16_09-25-54/model"
...
#model_evaluator = ModelEvaluator(pipeline=get_trained_model(model_path), eval_modes=eval_modes, language=language, batch_size=batch_size, samples=samples, save_loc=save_base_path+f"/orpo.df", ds=ds, tokenizer_for_chat_template=llama_3_1_base_tokenizer)
